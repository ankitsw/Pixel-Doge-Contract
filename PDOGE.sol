...
contract PixelDoge is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xA5C2631E9cEA6746A5B39Ac34B5d2f75a49A6686;
    ...
    constructor() public ERC20("Pixel Doge", "PDOGE") {
        ...
        */
        _mint(owner(), 2600000000000 * (10**18));
    }
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "PDOGE: The new dividend tracker must be owned by the PDOGE token contract");
...
contract PDOGEDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("PDOGE_Dividen_Tracker", "PDOGE_Dividend_Tracker") {
    	claimWait = 3600;
